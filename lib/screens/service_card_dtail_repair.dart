...
class ServiceCardDetailRepair extends StatefulWidget {
  ...
  @override
  State<ServiceCardDetailRepair> createState() =>
      _ServiceCardDetailRepairState();
}
                          ...
                          child: Align(
                            ...
                            child: Padding(
                              padding: EdgeInsets.only(
                                  left:
                                      figmaSpaceToPercentageWidth(21, context)),
                              child: Text(
                                widget.text,
                                style: TextStyle(
