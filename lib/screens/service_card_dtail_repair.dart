...
class ServiceCardDetailRepair extends StatefulWidget {
  final String text;
  final String categoryName;

  const ServiceCardDetailRepair(
      {Key? key, required this.text, required this.categoryName})
      : super(key: key);

  @override
  State<ServiceCardDetailRepair> createState() => _ServiceCardDetailRepairState();
}

class _ServiceCardDetailRepairState extends State<ServiceCardDetailRepair> {
                                  ...
                                  children: [
                                    ...
                                    if (isEditing) // Show editing icon only if not editing
                                      GestureDetector(
                                        ...
                                        child: Image.asset(
                                          ImageConstant.edit,
                                          height: figmaSpaceToPercentage(28, context),
                                          width: figmaSpaceToPercentageWidth(28, context),
                                          alignment: Alignment.center,
                                        ),
                                      ),
                                  ],
                                              ...
                                              children:[
                                                ...
                                                ElevatedButton(
                                                  ...
                                                  style: ElevatedButton.styleFrom(
                                                    ...
                                                    elevation: 5, // Specify the elevation
                                                    backgroundColor: Color(0xFF5FBD34), // Background color
                                                  ),
                                                  child: SizedBox(
                                                    width: figmaSpaceToPercentageWidth(366, context),
                                                    height: figmaSpaceToPercentage(40, context),
                                                    child: Center(
                                                      child: Text(
                                                        'Done',
                                              ...
                                              children:[
                                                ...
                                                ElevatedButton(
                                                  ...
                                                  style: ElevatedButton.styleFrom(
                                                    ...
                                                    foregroundColor: Color.fromRGBO(201, 201, 201, 1),// Background color
                                                  ),
                                                  child: SizedBox(
                                                    width: figmaSpaceToPercentageWidth(366, context),
                                                    height: figmaSpaceToPercentage(40, context),
